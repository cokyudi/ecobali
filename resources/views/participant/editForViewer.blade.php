                                ...
                                <div class="nav-vertical">
                                    ...
                                    <div class="tab-content px-1">
                                        ...
                                        <div class="tab-pane" id="tabCollection" >
                                            <div class="d-flex">
                                                <div class="p-2">
                                                    <button type="button" class="btn btn-info round btn-min-width">Continuity : <b id="continuity">None</b></button>
                                                </div>
                                                <div class="mr-auto p-2">
                                                    <button type="button" class="btn btn-info round btn-min-width">Potential : <b id="potential">Low</b></button>
                                                </div>
