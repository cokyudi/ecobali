                                    ...
                                    <div class="tab-content px-1">
                                        <div class="tab-pane active" id="tabCollection" >
                                            <div class="d-flex">
                                                ...
                                                <div class="p-2">
                                                    <button type="button" class="btn btn-sm round btn-min-width " style="width: 180px" id="btnContinuity" style="width: 180px">Continuity : <b id="continuity">None</b></button>
                                                </div>
                                                <div class="mr-auto p-2">
                                                    <button type="button" class="btn btn-sm round btn-min-width " style="width: 180px" id="btnPotential" style="width: 180px">Potential : <b id="potential">Low</b></button>
                                                </div>
                                            ...
                                            <div class="d-flex">
                                                <div class="pr-2 pl-2 pt-0">
                                                    <button type="button" class="btn btn-primary round btn-sm btn-min-width" style="width: 180px">Total : <b id="totalubc"> Kg</b></button>
                                                </div>
                                                <div class="mr-auto pr-2 pl-2 pt-0">
                                                    <button type="button" class="btn btn-secondary round btn-sm btn-min-width " style="width: 180px">Average : <b id="average"> Kg</b></button>
                                                </div>
                                            </div>
