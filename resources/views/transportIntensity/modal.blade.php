<div class="modal fade text-left" id="transportIntensityModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="transportIntensityForm" name="transportIntensityForm" class="form-horizontal">
                    <input type="hidden" id="transportIntensity_id" name="transportIntensity_id" value="">
