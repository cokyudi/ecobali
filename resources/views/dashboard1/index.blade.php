                  ...
                  <div class="card-body">
                    <div class="media d-flex">
                      <div class="media-body text-left">
						...
						<div class="row">
							<div class="col-5">
								<h4 class="font-large-1" id="total_collection_ton"></h4>
							</div>
							<div class="col-7">
    ...
    <div class="card">
      ...
      <div class="card-content collapse show">
          <div class="btn-group pull-right mr-3" role="group" aria-label="Basic example">
            <button onclick="getLineChartData('week');" type="button" class="btn btn-sm btn-secondary"><i class="ft-plus"></i></button>
            <button onclick="getLineChartData('month');" type="button" class="btn btn-sm btn-secondary"><i class="ft-minus"></i></button>
          </div>
