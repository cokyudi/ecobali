<div class="modal fade text-left" id="areaModal" aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="areaForm" name="areaForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="area_name" name="area_name" placeholder="Enter Area Name" value="" maxlength="50" required="">
                        </div>
                    </div>
                    <div class="form-group">
