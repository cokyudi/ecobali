<div class="modal fade text-left" id="regencyModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="regencyForm" name="regencyForm" class="form-horizontal">
                    <input type="hidden" id="regency_id" name="regency_id" value="">
                    ...
                    <div class="form-group">
                        <label for="name" class="control-label">Regency</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="regency_name" name="regency_name" placeholder="Enter Regency Name" value="" maxlength="50" required="">
                        </div>
                    </div>
                    <div class="form-group">
