!(function (n, a, o) {
    ...
    if (
        (o(n).on("load", function () {
            ...
            !1 === o.app.nav.initialized && o.app.nav.init({ speed: 300 }),
                ...
                o('a[data-action="collapse"]').on("click", function (e) {
                    e.preventDefault(), o(this).closest(".card").children(".card-content").collapse("toggle"), o(this).closest(".card").find('[data-action="collapse"] i').toggleClass("ft-check ft-minus");
                }),
                ...
                0 < o(".scrollable-container").length &&
            ...
            "vertical-compact-menu" != e &&
                ...
                ("vertical-compact-menu" != e && "horizontal-menu" != e) ||
                    (o(".main-menu-content").find("li.active").parents("li:not(.nav-item)").addClass("open"), o(".main-menu-content").find("li.active").parents("li").addClass("active")),
        ...
        setTimeout(function () {
            var e,
                n = a.querySelector(".main-menu");
            0 < o(n).length &&
                ((e = new Hammer(n)).get("pan").set({ direction: Hammer.DIRECTION_ALL, threshold: 100 }),
        ...
        if (0 < o(t).length)
            new Hammer(t).on("panleft", function (e) {
                if (l.hasClass("vertical-overlay-menu")) return o.app.menu.hide(), !1;
            });
    }
    o(a).on("click", ".menu-toggle, .modern-nav-toggle", function (e) {
        return (
            e.preventDefault(),
            o(".user-profile .user-info .dropdown").hasClass("show") && (o(".user-profile .user-info .dropdown").removeClass("show"), o(".user-profile .user-info .dropdown .dropdown-menu").removeClass("show")),
            o.app.menu.toggle(),
            setTimeout(function () {
                o(n).trigger("resize");
            }, 200),
            ...
            o(".vertical-overlay-menu .navbar-with-menu .navbar-container .navbar-collapse").hasClass("show") && o(".vertical-overlay-menu .navbar-with-menu .navbar-container .navbar-collapse").removeClass("show"),
            !1
        );
    }),
        o(a).on("click", ".open-navbar-container", function (e) {
        ...
        o(".carousel").carousel({ interval: 6000 }),
        ...
        "undefined" != typeof screenfull &&
            screenfull.enabled &&
            o(a).on(screenfull.raw.fullscreenchange, function () {
